...
ST1 – from the start of Switch Task just after transfer
...
rm("Dates","Data","monkey")

monkey <- dlgInput("Enter monkey", Sys.info()["user"])$res

# Where are the data?
# 3 folders
# This is dones longhand as only needs to be done once
##ST3 (original dataset used here)
#path <- file.path("/Users/charliewilson/Dropbox/Reversible Cognition/Domenech_Analysis/Behaviour/Recordings",monkey); #Where are the data? You need to change this for your data location
#save.path <- file.path("/Users/charliewilson/Dropbox/Reversible Cognition/Domenech_Analysis/Behaviour/Recordings"); #Path to save your data frame. Try not to put it in with the raw data

##ST1 
#path <- file.path("/Users/charliewilson/Dropbox/Brain Lyon/Reversible Cognition/Domenech_Analysis/Behaviour/ST_Crit",monkey); #Where are the data? You need to change this for your data location
#save.path <- file.path("/Users/charliewilson/Dropbox/Brain Lyon/Reversible Cognition/Domenech_Analysis/Behaviour/ST_Crit"); #Path to save your data frame. Try not to put it in with the raw data

##ST2 
#path <- file.path("/Users/charliewilson/Dropbox/Brain Lyon/Reversible Cognition/Domenech_Analysis/Behaviour/ST_No_Crit",monkey); #Where are the data? You need to change this for your data location
#save.path <- file.path("/Users/charliewilson/Dropbox/Brain Lyon/Reversible Cognition/Domenech_Analysis/Behaviour/ST_No_Crit"); #Path to save your data frame. Try not to put it in with the raw data

#Choose which dataset you want and select a path
...
#Save
save(file = paste(save.path,"/Data_Domenech_ST2_",monkey,".Rdata",sep = ""),Data, Dates) # Save monkey specific data frame
...
for(m in Monkey){
  for(p in Phase){
    load(file = paste(paths,p,"/Data_Domenech_",p,"_",m,".Rdata",sep = ""))
    print(paste(paths,p,"/Data_Domenech_",p,"_",m,".Rdata",sep = "")) 
    Data <- Data %>%
